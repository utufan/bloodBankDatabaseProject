...
<body>
    ...
    <body>
        <div class="col-md-1 mt-4" title="Patates">
            <button class="homeBut" onclick="window.location='homepage.php'"><i class="fa fa-home"></i></button>
        </div>
        <div>
            <h1 class="text-center">Welcome Admin</h1>
        </div>
        <div class="col-md-4 offset-md-2 " style="margin-top:100px">

            <div class="row">
                <div class="col-md-2  offset-md-6">
                    <button type="button" onclick="window.location='personTable.php'" class="customBtn btn">PERSON
                        TABLE</button>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4  offset-md-6">
                    <button type="button" onclick="window.location='patientTable.php'" class="customBtn btn">PATIENT
                        TABLE</button>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4  offset-md-6">
                    <button type="button" onclick="window.location='donorTable.php'" class="customBtn btn">DONOR
                        TABLE</button>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4  offset-md-6">
                    <button type="button" onclick="window.location='hospitalTable.php'" class="customBtn btn">HOSPITAL
                        TABLE</button>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4  offset-md-6">
                    <button type="button" onclick="window.location='bloodbankTable.php'" class="customBtn btn">BLOOD
                        BANK TABLE</button>
                </div>
            </div>
        </div>
