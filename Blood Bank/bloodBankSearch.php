...
if (isset($_POST['did_search'])) {

    $did_search = $_POST['did_search'];

    $sql = "SELECT * FROM bloodbank WHERE did = '$did_search';";
    ...
    if (count($myarr) > 0) {
        ...
        echo "<script>alert('Donor Successfully Found.')</script>";
    } else {
...
if (isset($_POST['bbid_search'])) {

    $bbid_search = $_POST['bbid_search'];

    $sql = "SELECT * FROM bloodbank WHERE bbid = '$bbid_search';";
    ...
    if (count($myarr) > 0) {
        ...
        echo "<script>alert('Blood Bank Successfully Found.')</script>";
    } else {
        echo "<script>alert('Failed to Find.')</script>";
    }
}
    ...
    <div class="container-fluid" style="height: 300px;">
        <div class="row">
            <div class="text-center col-md-6 offset-md-3 mt-4">
                <h1>BLOOD BANK SEARCH RESULT TABLE</h1>
            </div>
            ...
            <div class="offset-md-1 mt-4" title="bloodBankSearch">
                <form method="post" action="bloodBankTable.php">
                    <input class="cusBut" id="submit" type="submit" value="RETURN TO BLOOD BANK TABLE"><br>
                </form>
