...
<body>
    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="row">
                <form action='login_page.php' method=POST class="text-center offset-md-5  " style="margin-top: 70px; display: flexbox" ;>

                    <h2 style="font-family: Arial;">Login Page</h2><br>
                    <input type='text' class="form-control" name='username' placeholder="Username" /> <br>

                    <input type='password' class="form-control" name='password' placeholder="Password" />
                    <br>
                    <input type='submit' class="btn btn-primary btn-block" value="Log in" name="log" />
