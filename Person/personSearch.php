...
if (isset($_POST['name_search'])) {
    ...
    $sql = "SELECT * FROM person WHERE name = '$name_search';";
...
<body class="example">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="offset-md-1 mt-4" title="personSearch">
                <form method="post" action="personTable.php">
                    <input class="cusBut" id="submit" type="submit" value="RETURN TO PERSON TABLE"><br>
                </form>
