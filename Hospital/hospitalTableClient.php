    ...
    function validateForm(formId) {
        ...
        for (index = 0; index < inputs.length; ++index) {
            ...
            if (inputs[index].value == null || inputs[index].value == "") {
                alert("Please Enter an Hospital ID to Search");
                return false;
            }
        }
    }
...
<body>
    ...
    <div class="container-fluid" style="height:67%">
        <div class="row">
            ...
            <div class="offset-md-1 mt-4">
                <form name="searchID" id="searchID" method="post" action="hospitalSearchClient.php" onsubmit="return validateForm('searchID');">
                    <div>
                ...
                <form name="searchName" id="searchName" method="post" action="hospitalSearchClient.php" onsubmit="return validateForm('searchName');">
                    <div>
                        <h4 class="textColor">To Search with Hospital Name in our Database</h4>
                    </div>
                    <input class="inputField" id="hname_search" type="text" name="hname_search" placeholder="Hospital Name to Search">
                    <input class="cusBut" id="submit" type="submit" value="SEARCH"><br>
                </form>
            </div>
        </div>
