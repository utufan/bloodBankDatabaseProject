...
if (isset($_POST['hid_search'])) {
    ...
    if (count($myarr) > 0) {
        ...
        echo "<script>alert('Hospital Successfully Found.')</script>";
    } else {
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="offset-md-1 mt-4" title="hospitalSearch">
                <form method="post" action="hospitalTable.php">
                    <input class="cusBut" id="submit" type="submit" value="RETURN TO HOSPITAL TABLE"><br>
                </form>
