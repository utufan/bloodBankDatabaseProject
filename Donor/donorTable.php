...
$check = mysqli_query($link, "SELECT * FROM donor_donate");
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="text-center col-md-6 offset-md-2 mt-4">
                <h1 class="textColor">DONOR TABLE</h1>
            </div>
            ...
            <div class="offset-md-1 mt-4">
                <div>
                    <h4 class="textColor">To Add a Donor into our Database</h4>
                </div>
                <form name="add" id="add" method="post" action="donorAdd.php" onsubmit="return validateForm('add');">
                ...
                <form name="search" id="search" method="post" action="donorSearch.php" onsubmit="return validateForm('search');">
                    <input class="inputField" id="did_search" type="text" name="did_search" placeholder="Donor ID">
