...
if (isset($_POST['did_search'])) {
    ...
    $sql = "SELECT * FROM donor_donate WHERE did = '$did_search';";
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="text-center col-md-6 offset-md-3 mt-4">
                <h1>Donor SEARCH RESULT TABLE</h1>
            </div>
            ...
            <div class="offset-md-1 mt-4" title="donorSearch">
                <form method="post" action="donorTable.php">
                    <input class="cusBut" id="submit" type="submit" value="RETURN TO DONOR TABLE"><br>
                </form>
