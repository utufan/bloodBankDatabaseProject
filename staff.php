        ...
        <div class="row">
            <nav style="background-color:white" class="navbar navbar-expand-lg navbar-light bg-white col-md-11 offset-md-1">
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    ...
                    <a id="login" style="text-decoration: none; color: #ff0000;" class="col-md-3 offset-md-3" href="login_pg.php">
                        Log In
                    </a>
                    <a id="logout" style="text-decoration: none; color: #ff0000;" class="col-md-3 offset-md-3 d-none" href="logout.php">
                        Log Out
                    </a>
                </div>
            </nav>
    ...
    <div class="container-fluid" style="height:67%">
        <div class="row">
            <div class="col-md-6 offset-md-3" style="margin-top:70px">
                <h1 class="text-center">Faruk Doğukan Köksal</h1> <br>
                <h1 class="text-center">Egemen Kopuz</h1><br>
                <h1 class="text-center">Hüseyin Tufan Usta</h1><br>
                <h1 class="text-center">Ceren Yıldırım</h1><br>
                <h1 class="text-center">Alper Giray</h1>
            </div>
        </div>
    </div>
    <div class="container-fluid" style="background-color:#E52C34; height:13%">
